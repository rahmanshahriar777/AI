                                        ...
                                        <div class="card-img-top">
                                            @if(config('services.google.maps_api_key'))
                                                <iframe width="100%" height="450" frameborder="0" style="border:0"
                                                    ...
                                                    src="https://www.google.com/maps/embed/v1/place?key={{ config('services.google.maps_api_key') }}&q={{ urlencode(($lead->leadaddress->address ?? '') . ', ' . ($lead->leadaddress->county ?? '') . ', ' . ($lead->leadaddress->postcode ?? '') . ', ' . ($lead->leadaddress->country ?? '')) }}"
                                                    allowfullscreen>
                                                </iframe>
                                            @else

        ...
        <div class="col-xxl">
            <div class="card">
                <div class="card-header header-elements">
                    <h5 class="card-title mb-0">Mail Template</h5>
                ...
                @endif
                <form class="card-body" method="POST" action="{{ route('mailtemplates.update', $mailTemplate->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="row mb-6">
                        <label class="col-sm-3 col-form-label" for="multicol-name">Name</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-name" name="name" class="form-control" placeholder="Formal Mail" value="{{ $mailTemplate->name }}" />
                        </div>
                    </div>
                    <div class="row mb-6">
                        <label class="col-sm-3 col-form-label" for="multicol-subject">Subject</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-subject" name="subject" class="form-control" placeholder="Subject" value="{{ $mailTemplate->subject }}" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="multicol-mailbody border-0 pb-6" id="multicol-mailbody" data-name="mailbody">{!! $mailTemplate->body !!}</div>
                            <textarea name="mailbody" id="mailbody" class="d-none"></textarea>
                        </div>
                    </div>

    ...
    <div class="row mb-6 gy-6">
        ...
        <div class="col-xxl">
            <div class="card">
                ...
                @endif
                <form class="card-body" method="POST" action="{{ route('mailtemplates.store') }}">
                    @csrf
                    <div class="row mb-6">
                        <label class="col-sm-3 col-form-label" for="multicol-name">Name</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-name" name="name" class="form-control" placeholder="Formal Mail" value="{{ old('name') }}" />
                        </div>
                    </div>
                    <div class="row mb-6">
                        <label class="col-sm-3 col-form-label" for="multicol-subject">Subject</label>
                        <div class="col-sm-9">
                            <input type="text" id="multicol-subject" name="subject" class="form-control" placeholder="Subject" value="{{ old('subject') }}" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="multicol-mailbody border-0 pb-6" id="multicol-mailbody" data-name="mailbody"></div>
                            <textarea name="mailbody" id="mailbody" class="d-none">{{ old('mailbody') }}</textarea>
                        </div>
                    </div>

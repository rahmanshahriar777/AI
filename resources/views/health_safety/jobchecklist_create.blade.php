...
@section('title', 'Create JOB Health & Safety Check')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('fjob-hs-check.store') }}" method="POST" enctype="multipart/form-data"
                        class="row g-6">
                        @csrf
                        @if ($errors->any())
                                        ...
                                        <div class="card-body">
                                            <div class="row g-6">
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="select2jobs" class="select2 form-select" name="job_id">
                                                        @foreach ($jobs as $job)
                                                            <option value="{{ $job->id }}">

...
@section('title', 'Create Health & Safety Tools Check')
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="{{ route('hs-tools.storecheck', $hsTool->id) }}" method="POST" class="row g-6">
                        @csrf
                        @if ($errors->any())
                                ...
                                <div class="col-12 col-lg-12">
                                    ...
                                    <div class="card mb-6">
                                        <div class="card-body">
                                            <div class="row g-6">
                                                <div class="col-md-6">
                                                    <label class="form-label" for="select2jobs">Tool</label>
                                                    <input type="text" class="form-control" value="{{ $hsTool->tool_name }}" disabled />
                                                </div>

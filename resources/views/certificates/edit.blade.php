                        ...
                        <div class="card mb-6">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="certificateName" class="form-control"
                                                    ...
                                                    value="{{ old('certificatename', $certificate->certificate_name) }}"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="certificateDetails" class="form-control" name="certificatedetails" rows="3"
                                                    placeholder="Enter certificate details here...">{{ old('certificatedetails', $certificate->description) }}</textarea>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="certificateValidity"
                                                    ...
                                                    value="{{ old('certificatevalidity', $certificate->validity_period) }}"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" id="conductedBy" class="form-control flatpickr-basic"
                                                    placeholder="Conducted By" name="conductedby"
                                                    value="{{ old('conductedby', $certificate->authorized_by) }}"
                                                    required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="row">
                                            <label class="col-sm-2 col-form-label text-sm-end" for="status">Status</label>
                                            <div class="col-sm-10">

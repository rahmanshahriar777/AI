...
@section('scripts')
    ...
    <script type="text/javascript">
        $(function() {
            let ajaxUrl = "{{ route('vehiclecategories.index') }}";
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#Vehicle-categories-table').DataTable().ajax.reload();
                            },
                            error: function() {
        ...
        <div
            ...
            <div class="d-flex justify-content-end mb-3">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#addVehicleCategoryModal">
                    <i class="icon-base ti tabler-plus"></i>
                    Add New Category
                </button>

                <!--Add Modal -->
                <div class="modal fade" id="addVehicleCategoryModal" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <form action="{{ route('vehiclecategories.store') }}" method="POST">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addVehicleCategoryModalTitle">Vehicle Category</h5>
